...
My name is Emily, and I am a sophomore chemical engineering student who loves dogs. I'm in the Stars Filter Theory subteam of AguaClara.
...
* I want to be more outgoing
  - I will be more involved on campus
...
![CornellSeal](https://github.com/EmilySpiek/personal-rep/blob/master/Images/flomo.jpg?raw=true)

Relative File Path:

![FloMo](/Images/flomo.jpg)

Adjusted:

<img
src="https://github.com/EmilySpiek/personal-rep/blob/master/Images/flomo.jpg?raw=true" height=400 width=350>
...
Chemical engineering combines chemistry with engineering to create large-scale chemical processes. The department website can be found [here](https://www.cheme.cornell.edu/).
